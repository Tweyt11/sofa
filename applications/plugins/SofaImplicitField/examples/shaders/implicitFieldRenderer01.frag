//-------autogenerated ----------------
// from: /home/dmarchal/projects/DEFROST/dev/sofa2/src/share/shaders/templates/implicitFieldRenderer.frag
...
{
	float Sphere2_result = sdSphere(pos, Sphere2_center, Sphere2_radius);
float Box1_result = sdBox(pos, Box1_size);
float Union2_result = min(Box1_result, Sphere2_result);
vec4 ssa2 = vec4(Union2_result, ssa1);
