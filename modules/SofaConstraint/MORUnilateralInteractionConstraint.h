...
******************************************************************************/
#ifndef SOFA_COMPONENT_CONSTRAINTSET_MORUNILATERALINTERACTIONCONSTRAINT_H
#define SOFA_COMPONENT_CONSTRAINTSET_MORUNILATERALINTERACTIONCONSTRAINT_H
#include "config.h"
...
#if  !defined(SOFA_COMPONENT_CONSTRAINTSET_MORUNILATERALINTERACTIONCONSTRAINT_CPP)
